        ...
        <div className="-mt-5 px-3 sm:px-10 lg:px-8 flex flex-col md:flex-row">
            <div className="w-full md:w-6/12 max-md:mb-6 md:pr-3">
                <Link href={"/save/u-save"}>
                    <SectionCard disabled={true} title='U Save'content='mock contents probably a short description on u save for better user understanding on what the navigation is about' Icon={Icons.vault} showGradient/>
                </Link>

            </div>
            <div className="w-full md:w-6/12 md:pl-3">
                <Link href={"/save/u-bugga"}>
                    <SectionCard disabled={true} title='U Bugga'content='mock contents probably a short description on u bugga for better user understanding on what the navigation is about' Icon={Icons.flower} showGradient/>
                </Link>
