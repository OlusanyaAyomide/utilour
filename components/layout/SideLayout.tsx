...
export default function SideLayout({closeSheet}:ISideLayout) {
    ...
    <div className='xs:mt-2 sm:pt-14 pt-4'>
        ...
        return(<Link href={item.url} key={key}>
            <button className={`w-full px-4 lg:px-6 outline-none flex-center mb-1 xs:mb-5  h-11  ${isActive?"pl-8 active-nav lg:pl-10 text-white":"hover:bg-accent"}`} onClick={closeSheet}>
